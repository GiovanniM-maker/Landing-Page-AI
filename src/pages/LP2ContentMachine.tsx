    ...
    <div className="bg-[#000000] text-[#F5F5F7] min-h-screen">
      ...
      <section id="hero" className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 border border-white/20 text-[#F5F5F7] font-display font-semibold rounded-lg hover:bg-white/5 transition-all"
              >
                Vedi il pricing
              </button>
            </div>
          ...
          >
            <p className="text-[10px] uppercase tracking-wider text-accent font-display font-semibold mb-4">
              Canone mensile
            </p>
            <p className="font-display font-bold text-5xl text-[#F5F5F7] mb-1">
            ...
            <div className="mt-6 pt-6 border-t border-white/10 flex items-center justify-between">
              <div>
                <p className="font-display font-semibold text-[#F5F5F7]">Audit Strategico</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-xs uppercase tracking-[0.2em] text-accent font-display font-semibold mb-6">
                Il problema
              </p>
              <blockquote className="font-display text-2xl sm:text-3xl font-medium text-[#F5F5F7] italic border-l-2 border-accent pl-8 mb-8 leading-relaxed">
            ...
            >
              ...
              <div className="rounded-xl border border-white/10 bg-[#1A1A1A] p-6">
                <p className="text-xs uppercase tracking-[0.2em] text-accent font-display font-semibold mb-3">Il costo reale</p>
                <p className="font-display text-xl sm:text-2xl font-medium text-[#F5F5F7] leading-relaxed">
      ...
      <section id="come-funziona" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <p className="text-xs uppercase tracking-[0.2em] text-accent font-display font-semibold mb-3">Come funziona</p>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-[#F5F5F7] mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-white/10 border border-white/10 rounded-xl overflow-hidden">
            {STEPS.map((step, i) => (
              ...
              >
                <span className="font-display text-6xl font-bold text-accent/10 block mb-4">{step.num}</span>
                <h3 className="font-display font-bold text-lg text-[#F5F5F7] mb-3">{step.title}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-xs uppercase tracking-[0.2em] text-accent font-display font-semibold mb-3">Cosa facciamo</p>
              <h2 className="font-display font-bold text-3xl text-[#F5F5F7] mb-4">
              ...
              <ul className="space-y-0">
                {DELIVERABLES.map((d, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-display font-semibold text-[#F5F5F7] mb-1">{d.title}</p>
            ...
            >
              <div className="rounded-xl border border-white/10 bg-[#1A1A1A] p-6">
                <h3 className="font-display font-bold text-lg text-[#F5F5F7] mb-6">Quanto costa farlo internamente?</h3>
                <div className="space-y-3">
                  ...
                  <div className="h-px bg-white/10 my-2" />
                  <div className="flex justify-between items-center py-2">
                    <span className="font-display font-semibold text-[#F5F5F7]">Con Auiki</span>
                    <span className="font-display font-bold text-2xl text-accent">€500/mese</span>
                  </div>
                </div>
      ...
      <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <p className="text-xs uppercase tracking-[0.2em] text-accent font-display font-semibold mb-3">Pricing</p>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-[#F5F5F7] mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            ...
            >
              <p className="text-[10px] uppercase tracking-wider text-accent font-display font-semibold mb-4">Audit Strategico · Una tantum</p>
              <p className="font-display font-bold text-5xl text-[#F5F5F7] mb-1">
                <span className="text-2xl text-accent align-top">€</span>500
              </p>
              ...
              <button onClick={() => scrollTo('contatti')} className="w-full py-4 border border-white/20 text-[#F5F5F7] font-display font-semibold rounded-lg hover:bg-white/5 transition-all">
                Inizia dall'Audit →
              </button>
            </motion.div>
            ...
            >
              <p className="text-[10px] uppercase tracking-wider text-accent font-display font-semibold mb-4">Gestione Completa · Mensile</p>
              <p className="font-display font-bold text-5xl text-[#F5F5F7] mb-1">
                <span className="text-2xl text-accent align-top">€</span>500
              </p>
              ...
              <button onClick={() => scrollTo('contatti')} className="w-full py-4 bg-accent text-white font-display font-semibold rounded-lg hover:bg-accent-hover transition-all">
                Prenota la call gratuita →
              </button>
          ...
          >
            <div>
              <p className="font-display font-semibold text-[#F5F5F7]">Investimento totale — Primi 3 mesi</p>
              <p className="text-sm text-gray-400">Audit una tantum + 3 mesi di gestione completa</p>
            </div>
            <p className="font-display font-bold text-3xl text-accent">€2.000 <span className="text-base font-normal text-gray-400">totali</span></p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#0A0A0A] border-y border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display font-bold text-3xl text-[#F5F5F7] mb-12">
            ...
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-display font-semibold text-[#F5F5F7]">{t.name}</p>
      ...
      <section id="faq" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#000000]">
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <p className="text-xs uppercase tracking-[0.2em] text-accent font-display font-semibold mb-3">Domande frequenti</p>
            <h2 className="font-display font-bold text-3xl text-[#F5F5F7]">
